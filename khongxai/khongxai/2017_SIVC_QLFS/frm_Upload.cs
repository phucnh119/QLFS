...
namespace _2017_SIVC_QLFS
{
    public partial class frm_Upload : Form
    {
        ...
        private void cmd_UpLoad_Click(object sender, EventArgs e)
        {
            ...
            //if (check = true)
            //{
            //    sql = "UPDATE ValuationCertificate" + "set ValuationCertificate.CheckFile = ValuationCertificate.FilePath" + "UPDATE ValuationCertificate" + "set ValuationCertificate.CheckFile = 'Có File'" + "where CheckFile like 'ftp%'";
            //    con.ExecuteNonQuery(sql);
            //    LoadData();
            //}
